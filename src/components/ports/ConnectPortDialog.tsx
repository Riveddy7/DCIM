...
export function ConnectPortDialog({ portA, portA_assetType, tenantId, assetsInSameRack, onSuccess, onCancel }: ConnectPortDialogProps) {
  ...
  const handleSelectAsset = async (asset: AssetWithPorts) => {
    ...
    if (error) {
      ...
      // Rule: If connecting from a Switch to a Patch Panel, only show Front ports.
